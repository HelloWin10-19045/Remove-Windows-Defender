...
del /f /q /a "%SystemRoot%\System32\drivers\wd"
...
reg delete "HKLM\SOFTWARE\Classes\WindowsDefender" /F
reg delete "HKLM\SOFTWARE\Classes\AppX9kvz3rdv8t7twanaezbwfcdgrbg3bck0" /F
...
reg delete "HKLM\SOFTWARE\Classes\Local Settings\MrtCache\C:%5CWindows%5CSystemApps%5CMicrosoft.Windows.AppRep.ChxApp_cw5n1h2txyewy%5Cresources.pri" /F
