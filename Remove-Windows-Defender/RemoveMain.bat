...
del /f /s /q /a "%SystemDrive%\Program Files\Microsoft Defender"
del /f /s /q /a "%SystemDrive%\Program Files\Microsoft Defender Advanced Threat Protection"
...
rd /s /q "%SystemDrive%\Program Files\Microsoft Defender"
rd /s /q "%SystemDrive%\Program Files\Microsoft Defender Advanced Threat Protection"
rd /s /q "%SystemDrive%\Program Files\Windows Security"

title 移除Windows Defender中...(2/9)
...
title 移除Windows Defender中...(4/9)
echo 正在删除 SystemApps 中的Windows Defender用户界面...
...
title 移除Windows Defender中...(5/9)
echo 正在删除 System32 中的Windows Defender支持程序...
...
title 移除Windows Defender中...(8/9)
echo 正在禁用Windows Defender的内存完整性...
bcdedit /set hypervisorlaunchtype off
cls

title 移除Windows Defender中...(9/9)
echo 正在退出BCPE环境...
